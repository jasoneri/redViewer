...
export function useMobileShelfModel(appState: AppState, deps: MobileShelfModelDeps) {
  ...
  const libraryWorkspaceProps: LibraryWorkspaceProps = {
    ...
    shelfActions: {
      ...
      setFilterDraft,
      clearMultiCheck: libraryWorkspaceController.clearMultiCheck,
      exitMultiCheck: libraryWorkspaceController.exitMultiCheck,
      runMultiCheckBatch: libraryReaderActions.runMultiCheckBatch,
      startMultiCheckDrag: libraryReaderActions.startMultiCheckDrag,
      moveMultiCheckDrag: libraryReaderActions.moveMultiCheckDrag,
      finishMultiCheckDrag: libraryReaderActions.finishMultiCheckDrag,
      selectAllCurrentPage: libraryWorkspaceController.selectAllCurrentPage,
      toggleMultiCheckId: libraryWorkspaceController.toggleMultiCheckId,
